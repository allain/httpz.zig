...
- [x] **CONNECT method** (RFC 2616 §9.9) - Tunneling for proxies (enabled via `Config.enable_proxy`)
...
- [x] **Via header** (RFC 2616 §14.45) - Auto-added to proxied responses when `Config.enable_proxy` is set
