...
fn handleEvents(_: *const httpz.Request, _: *const httpz.Router.Params, _: std.Io) httpz.Response {
...
fn handleLarge(_: *const httpz.Request, _: *const httpz.Router.Params, _: std.Io) httpz.Response {
